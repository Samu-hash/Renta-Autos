...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Renta Autos 2020</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!--MODULE,CONTRUCCION DE COMPONENTES-->
<script src="<?= base_url(); ?>/vendor/admin/controllers/dashboard-ini.js" type="module"></script>
